...
const News = ({ simplified }) => {
  ...
  // hooks to fetch news and currencies
          ...
          <Card hoverable className='news-card'>
            <a href={news.url} target="_blank" rel="noreferrer">
              <div className="news-image-container">
                ...
                <img style={{ maxWidth: '120px', maxHeight: '100px', borderRadius: '8px' }} src={news.image?.thumbnail?.contentUrl || demoImage} alt="news" ></img>
              </div>
